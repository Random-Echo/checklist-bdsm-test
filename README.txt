...
V1.1.29 : lecture mobile ajustée : l’épingle devient un simple indicateur d’état (affiché seulement si la pratique est épinglée), le niveau est retiré, et le risque n’apparaît plus que pour les pratiques à surveiller sous forme d’un pictogramme sous l’épingle. En édition mobile, la note partenaire reste grisée. Desktop inchangé.
