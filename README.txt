...
V1.1.18 : finalisation de la nouvelle vue mobile en cartes, explications via info, notes repliables, contrôles Envie/Après dynamiques et audit responsive. La vue desktop reste inchangée.

V1.1.18 : direction artistique mobile premium : surfaces superposées légèrement teintées, cartes plus distinctes, contraste renforcé entre contenu / préférences / notes, accents bleu-prune plus sobres et résumé de l'autre rôle mieux intégré. Desktop inchangé.
